...
const InquiryForm = () => {
  ...
  const outletContext = useOutletContext()                         // 👈 get context
...
const onFinish = async (values) => {
  try {
    ...
    // ✅ Get the source name from the already fetched sources array
    ...
    await createMutation.mutateAsync({
      ...
      source: sourceName,          // ✅ store the source name
    ...
    <div style={{ fontFamily: fontBody }}>
      ...
      >
        <Form form={form} layout="vertical" onFinish={onFinish}>
          ...
          <Row gutter={16}>
            <Col xs={24} sm={6}>
              <Form.Item name="salutation" label={<span style={labelStyle}>Prefix</span>}>
                <Select placeholder="None" allowClear style={{ fontFamily: fontBody }} dropdownStyle={{ fontFamily: fontBody }}>
            ...
            <Col xs={24} sm={9}>
              <Form.Item name="first_name" label={<span style={labelStyle}>First Name</span>} rules={[{ required: true, message: 'First name is required' }]}>
          ...
          <Row gutter={16}>
            ...
            <Col xs={24} sm={9}>
              <Form.Item name="gender" label={<span style={labelStyle}>Gender</span>}>
                <Select placeholder="Select" allowClear style={{ fontFamily: fontBody }} dropdownStyle={{ fontFamily: fontBody }}>
          ...
          <Row gutter={16}>
            <Col xs={24} sm={12}>
              <Form.Item name="mobile" label={<span style={labelStyle}>Mobile</span>} rules={[{ required: true, message: 'Mobile is required' }]}>
                <Input maxLength={15} style={{ fontFamily: fontBody }} />
              </Form.Item>
            </Col>
            <Col xs={24} sm={12}>
          ...
          {/* ===== Address ===== */}
          <Divider style={{ color: primaryColor, fontFamily: fontHeading }}>Address</Divider>
          ...
          {/* ===== School Info ===== */}
          <Divider style={{ color: primaryColor, fontFamily: fontHeading }}>School Info (optional)</Divider>
          <Row gutter={16}>
            <Col span={8}>
          ...
          {/* ===== Course & Source ===== */}
          <Divider style={{ color: primaryColor, fontFamily: fontHeading }}>Course & Source</Divider>
          <Row gutter={16}>
            <Col xs={24} sm={12}>
              <Form.Item name="interested_course_id" label={<span style={labelStyle}>Interested Course</span>}>
                <Select placeholder="Select course" allowClear style={{ fontFamily: fontBody }} dropdownStyle={{ fontFamily: fontBody }}>
            ...
            <Col xs={24} sm={12}>
              <Form.Item name="source_id" label={<span style={labelStyle}>Source</span>}>
                <Select placeholder="Select source" allowClear style={{ fontFamily: fontBody }} dropdownStyle={{ fontFamily: fontBody }}>
          ...
          {/* ===== Additional Info ===== */}
          <Divider style={{ color: primaryColor, fontFamily: fontHeading }}>Additional Info</Divider>
          <Row gutter={16}>
            <Col xs={24} sm={12}>
