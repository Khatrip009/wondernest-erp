...
import InstallBanner from './components/InstallBanner'; // ✅ import the banner
          ...
          element={
            <ProtectedRoute>
              <OrganizationProvider>
                <ScopeProvider>
                  {/* PWA Install Banner – only shown when user is logged in and not on login page */}
                  {bannerVisible && deferredPrompt && (
